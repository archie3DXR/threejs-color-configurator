...
Command: npx gltfjsx@6.2.10 assets/scene.gltf --transform
Files: assets/scene.gltf [17.08KB] > scene-transformed.glb [1.58MB] (-9170%)
...
const Scene = (props) => {
  ...
  const color = useTexture("assets/textures/Leather034D_1K_Color.jpg")
  const colorMetal= useTexture("assets/textures/Metal041A_1K_Color.jpg")
  const roughness = useTexture("assets/textures/Leather034D_1K_Roughness.jpg")
  const metalness = useTexture("assets/textures/Leather034D_1K_Roughness.jpg")
  const metalMetalness = useTexture("assets/textures/Metal041A_1K_Metalness.jpg")
  ...
  switch (material) {
    case "metal":
      fieldProps = {
        ...
        "material-metalnessMap":metalMetalness
      }
      break;
    default:
      fieldProps = {
